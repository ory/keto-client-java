...
public class PostCheckPermissionOrErrorBody {
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostCheckPermissionOrErrorBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostCheckPermissionOrErrorBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
