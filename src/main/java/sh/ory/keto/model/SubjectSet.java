...
public class SubjectSet {
   ...
   * @throws IOException if the JSON Element is invalid with respect to SubjectSet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SubjectSet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
