...
public class PostCheckPermissionBody {
   ...
   * @return the PostCheckPermissionBody instance itself
   */
  public PostCheckPermissionBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.namespace, postCheckPermissionBody.namespace) &&
        ...
        Objects.equals(this.additionalProperties, postCheckPermissionBody.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostCheckPermissionBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostCheckPermissionBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PostCheckPermissionBody>() {
           ...
           public PostCheckPermissionBody read(JsonReader in) throws IOException {
             ...
             PostCheckPermissionBody instance = thisAdapter.fromJsonTree(jsonObj);
