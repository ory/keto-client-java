...
public class ErrorGeneric {
  ...
  public ErrorGeneric error(GenericError error) {
    this.error = error;
    return this;
  }
   ...
   * @return the ErrorGeneric instance itself
   */
  public ErrorGeneric putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.error, errorGeneric.error)&&
        Objects.equals(this.additionalProperties, errorGeneric.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ErrorGeneric
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ErrorGeneric.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (String requiredField : ErrorGeneric.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ErrorGeneric>() {
           ...
           public ErrorGeneric read(JsonReader in) throws IOException {
             ...
             ErrorGeneric instance = thisAdapter.fromJsonTree(jsonObj);
