...
public class Relationships {
  ...
  private List<Relationship> relationTuples = new ArrayList<>();

  public Relationships() {
  }

  public Relationships nextPageToken(String nextPageToken) {
  ...
  public Relationships relationTuples(List<Relationship> relationTuples) {
    this.relationTuples = relationTuples;
    return this;
  }

  public Relationships addRelationTuplesItem(Relationship relationTuplesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<Relationship> getRelationTuples() {
    return relationTuples;
  }

  public void setRelationTuples(List<Relationship> relationTuples) {
    this.relationTuples = relationTuples;
  }
   ...
   * @return the Relationships instance itself
   */
  public Relationships putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextPageToken, relationships.nextPageToken) &&
        Objects.equals(this.relationTuples, relationships.relationTuples)&&
        Objects.equals(this.additionalProperties, relationships.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextPageToken, relationTuples, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("relation_tuples") != null && !jsonObj.get("relation_tuples").isJsonNull()) {
        ...
        if (jsonArrayrelationTuples != null) {
          ...
          for (int i = 0; i < jsonArrayrelationTuples.size(); i++) {
            Relationship.validateJsonElement(jsonArrayrelationTuples.get(i));
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Relationships>() {
           ...
           public Relationships read(JsonReader in) throws IOException {
             ...
             Relationships instance = thisAdapter.fromJsonTree(jsonObj);
