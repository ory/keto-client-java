...
public class HealthNotReadyStatus {
   ...
   * @return the HealthNotReadyStatus instance itself
   */
  public HealthNotReadyStatus putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errors, healthNotReadyStatus.errors)&&
        Objects.equals(this.additionalProperties, healthNotReadyStatus.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to HealthNotReadyStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HealthNotReadyStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<HealthNotReadyStatus>() {
           ...
           public HealthNotReadyStatus read(JsonReader in) throws IOException {
             ...
             HealthNotReadyStatus instance = thisAdapter.fromJsonTree(jsonObj);
